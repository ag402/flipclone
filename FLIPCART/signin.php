...
<title>FLIPCART-Signin Page</title>
...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/img1.png" data-speed="0.8"></div>
		<!-- <div class="container">
			<div class="row">
				<div class="col">
	...
	<div class="contact">
		<div class="container">
			...
			<div class="row contact_form_row" id="signin_from">
				<div class="col">
